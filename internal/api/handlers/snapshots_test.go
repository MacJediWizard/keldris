...
func (m *mockSnapshotStore) CreateSnapshotMount(_ context.Context, _ *models.SnapshotMount) error {
	return nil
}

func (m *mockSnapshotStore) UpdateSnapshotMount(_ context.Context, _ *models.SnapshotMount) error {
	return nil
}

func (m *mockSnapshotStore) GetSnapshotMountByID(_ context.Context, _ uuid.UUID) (*models.SnapshotMount, error) {
	return nil, nil
}

func (m *mockSnapshotStore) GetActiveSnapshotMountBySnapshotID(_ context.Context, _ uuid.UUID, _ string) (*models.SnapshotMount, error) {
	return nil, nil
}

func (m *mockSnapshotStore) GetSnapshotMountsByOrgID(_ context.Context, _ uuid.UUID) ([]*models.SnapshotMount, error) {
	return nil, nil
}

func (m *mockSnapshotStore) GetActiveSnapshotMountsByAgentID(_ context.Context, _ uuid.UUID) ([]*models.SnapshotMount, error) {
	return nil, nil
}

func (m *mockSnapshotStore) DeleteSnapshotMount(_ context.Context, _ uuid.UUID) error {
	return nil
}
...
func TestListFiles(t *testing.T) {
	...
	t.Run("path filter with no repo", func(t *testing.T) {
		store := &mockSnapshotStore{
			user:             dbUser,
			agent:            agent,
			backupBySnapshot: map[string]*models.Backup{snapshotID: backup},
