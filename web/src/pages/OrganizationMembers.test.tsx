...
vi.mock('../hooks/useOrganizations', () => ({
	useCurrentOrganization: vi.fn(() => ({
		data: { organization: { id: 'org1', name: 'Test Org' } },
	})),
	useOrgMembers: vi.fn(),
...
import { useOrgInvitations, useOrgMembers } from '../hooks/useOrganizations';
...
describe('OrganizationMembers', () => {
	...
	it('hides invite button for non-admin', () => {
		vi.mocked(useMe).mockReturnValue({
			data: { id: 'u1', current_org_id: 'org1', current_org_role: 'member' },
		} as ReturnType<typeof useMe>);
		vi.mocked(useOrgMembers).mockReturnValue({
			data: [],
			isLoading: false,
