...
vi.mock('../hooks/useOrganizations', () => ({
	...
	useUpdateOrganization: () => ({ mutateAsync: vi.fn(), isPending: false, isError: false }),
...
describe('OrganizationSettings', () => {
	...
	it('renders title', () => {
		...
		vi.mocked(useCurrentOrganization).mockReturnValue({
			data: { organization: { id: 'org1', name: 'Test Org', slug: 'test-org', created_at: '2024-01-01T00:00:00Z' } },
			isLoading: false,
	...
	it('shows loading state', () => {
		vi.mocked(useMe).mockReturnValue({ data: { id: 'u1', current_org_id: 'org1', current_org_role: 'admin' } } as ReturnType<typeof useMe>);
		vi.mocked(useCurrentOrganization).mockReturnValue({ data: undefined, isLoading: true } as ReturnType<typeof useCurrentOrganization>);
		renderPage();
	...
	it('shows organization name', () => {
		...
		vi.mocked(useCurrentOrganization).mockReturnValue({
			data: { organization: { id: 'org1', name: 'My Org', slug: 'my-org', created_at: '2024-01-01T00:00:00Z' } },
			isLoading: false,
		} as ReturnType<typeof useCurrentOrganization>);
		renderPage();
